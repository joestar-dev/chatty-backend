...
export class Add {
  ...
  public async profileImage(req: Request, res: Response): Promise<void> {
    ...
    const url = `https://res.cloudinary.com/deghbmw6y/image/upload/v${result.version}/${result.public_id}`;
    const cacheUser: IUserDocument = await userCache.updateSingleUserItemInCache(
